 ...
 */
final class Version20251010082352 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create Video Games table';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE video_games (id INT AUTO_INCREMENT NOT NULL, editor_id INT NOT NULL, title VARCHAR(255) NOT NULL, release_date DATE NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_24BC6C506995AC4C (editor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE video_games ADD CONSTRAINT FK_24BC6C506995AC4C FOREIGN KEY (editor_id) REFERENCES editors (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE video_games DROP FOREIGN KEY FK_24BC6C506995AC4C');
